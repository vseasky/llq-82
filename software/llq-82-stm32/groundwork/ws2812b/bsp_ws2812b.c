 ...
 * @LastEditTime                    : 2022-01-19 14:54:31
    ...
    for (i = 0; i < 87; i++)
    {
        ...
        */
        ...
        case L_DIN_1:
            ...
            break;
        case L_DIN_2:
            ws2812b_irq_cfg[1][i - 28].WS2812B_RGB = board_rgb_led[i].rgb_set.WS2812B_RGB;
            break;
        case L_DIN_3:
            ws2812b_irq_cfg[2][i - 54].WS2812B_RGB = board_rgb_led[i].rgb_set.WS2812B_RGB;
            break;
        }
    }
}
