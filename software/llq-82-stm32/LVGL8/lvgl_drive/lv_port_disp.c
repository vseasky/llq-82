 ...
 * @LastEditTime: 2022-01-23 23:19:16
 * @LastEditors: Please set LastEditors
 * @Description                     : https://github.com/SEASKY-Master
 * @FilePath                        : \keyboard_v4\LVGL8\lvgl_drive\lv_port_disp.c
...
#ifdef Buffering_LVGL_T
#if Buffering_LVGL_T == 1
    /* Example for 1) */
...
static void disp_flush(lv_disp_drv_t * disp_drv, const lv_area_t * area, lv_color_t * color_p)
{
	...
	/*注意高低位!!!!*/
	LCD_Fill_DMA(area->x1,area->y1,area->x2,area->y2,(uint8_t*)color_p);
    /*IMPORTANT!!!
